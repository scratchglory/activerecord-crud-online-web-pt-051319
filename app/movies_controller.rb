...
def can_be_created_in_a_block(
	args = { title: 'Home Alone', release_date: 1_990 }
)
...
def can_be_found_updated_and_saved
	...
	update_movie.update(title: 'Even Awesomer Flick')
	update_movie.save
end
...
def can_update_multiple_items_at_once
	...
	5.times { |i| Movie.create(title: "Movie_#{i}", release_date: 2_000 + i) }
...
def can_destroy_all_items_at_once
	10.times { |i| Movie.create(title: "Movie_#{i}") }
	Movie.destroy_all
end
